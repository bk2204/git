...
gc.autoLooseMapLimit::
	When there are more than this many loose object maps in the repository,
	`git gc --auto` consolidates them into one larger loose object map.

...
#define GRAPH_OID_VERSION_LBLAKE2 1
#define GRAPH_OID_LEN_LBLAKE2 GIT_LBLAKE2B_RAWSZ
#define GRAPH_OID_VERSION GRAPH_OID_VERSION_LBLAKE2
#define GRAPH_OID_LEN GRAPH_OID_LEN_LBLAKE2

 ...
 * your compiler is reasonably recent, you can try to enable C99 support (for
 * GCC and clang, this can be done by setting CFLAGS=-std=c99 when building).
 * If you encounter a problem and can't enable C99 support on your system, you
 * can remove this #if directive, but please report the details of your system
